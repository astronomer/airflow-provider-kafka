...
class EventTriggersDagOperator(BaseOperator):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.trigger_dag_run_instance = trigger_dag_run_instance

        if not isinstance(self.trigger_dag_run_instance,TriggerDagRunOperator):
            raise TypeError(f"parameter trigger_dag_run_instance is expected to be of type TriggerDagRunOperator, got {type(trigger_dag_run_instance)}")
